...
// var roi  → your imported Polygon (4 vertices)
// Year list to map
...
Export.image.toDrive({
  ...
  folder: 'GEE_Exports', // Optional: your Google Drive folder name
  fileNamePrefix: 'urban_expansion',
  region: roi, // Your region of interest
  scale: 30, // Landsat resolution
  crs: 'EPSG:4326', // Optional: output projection
  fileFormat: 'GeoTIFF'
});
